...
- Role direction: Heavy melee damage
- Resource: Rage
- Primary stat direction: Strength
- Auto-attack: Heavy Swing

## Spec Theme

Large weapon hits, armor pressure, controlled Rage spending.
...
The specialization uses **Heavy Swing** as its spec-defined repeating auto-attack.
...
The Arms tree contains:

- Tier 1 — 3 options
- Tier 2 — 3 options
- Tier 3 — 2 mutually exclusive capstones

If the hero's first talent point is spent in this tree, Arms becomes the hero's specialization.
...
- Large weapon hits
- Armor pressure
- Controlled Rage spending

Individual nodes remain to be designed.

## Cooldown Direction

The Arms specialization may use class-wide cooldowns plus spec-specific cooldowns that reinforce its role.

The hero equips exactly two cooldown abilities at a time.

## Ultimate Direction

The Arms specialization may have one or more compatible ultimate choices.
