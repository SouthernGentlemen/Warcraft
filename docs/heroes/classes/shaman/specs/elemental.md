...
- Role direction: Ranged spell damage
- Resource: Mana
- Primary stat direction: Intellect
- Auto-attack: Lightning Bolt

## Spec Theme

Elemental spell damage, burst, overload-style effects, ranged pressure.
...
The specialization uses **Lightning Bolt** as its spec-defined repeating auto-attack.
...
The Elemental tree contains:

- Tier 1 — 3 options
- Tier 2 — 3 options
- Tier 3 — 2 mutually exclusive capstones

If the hero's first talent point is spent in this tree, Elemental becomes the hero's specialization.
...
The Elemental specialization may use class-wide cooldowns plus spec-specific cooldowns that reinforce its role.

The hero equips exactly two cooldown abilities at a time.

## Ultimate Direction

The Elemental specialization may have one or more compatible ultimate choices.
