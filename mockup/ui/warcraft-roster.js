...
function defaults(){return {heroes:DEFAULT_HEROES.map(h=>Object.assign({},h,{equipment:blankEquipment(),talentBuild:{primarySpec:h.spec,picks:[]}})),loadouts:Array.from({length:5},(_,i)=>({id:"party-"+(i+1),name:"Party "+(i+1),size:3,heroIds:[],ready:false})),quests:defaultQuests()};}
...
global.WarcraftRoster=Object.freeze({PARTY_SIZES,getState,hero,validateRaceClass,updateHero,setEquipment,setTalentBuild,validateLoadout,updateLoadout,dispatchQuest,completeQuest,reset});
})(window);
